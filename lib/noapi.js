...
class NoApi {
            ...
            try {
                if (Array.isArray(urls)) {
                    urls.forEach((url) => __awaiter(this, void 0, void 0, function* () {
                        const { sourceCode, fullFilePath } = yield this.generateApiCode(url);
                        (0, tools_js_1.writeToFile)(fullFilePath, sourceCode);
                    }));
                }
                else {
                    const { url, filePath, funcName } = urls;
                    const { sourceCode, fullFilePath } = yield this.generateApiCode(url, filePath, funcName);
                    (0, tools_js_1.writeToFile)(fullFilePath, sourceCode);
                }
            }
            catch (error) {
     ...
     * @param url
     */
    generateApiCode(url, filePath, funcName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let codeStr = '';
            if (!(0, tools_js_1.checkExists)(fullFilePath)) {
