...
exports.loadConfig = exports.createConfig = exports.definedNoApiConfig = exports.createNoApi = void 0;
/*
...
class NoApi {
    ...
    auto() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, api_js_1.generateBatch)(this.paths, this.definitions, this.config);
        });
    }
    /**
     * 根据URL生成api函数
    ...
    generateApiFile(url) {
        ...
        const { funcName, fileName, dirName } = (0, api_js_1.formatNameByUrl)(url);
        ...
        if (!fs_1.default.existsSync(filePath)) {
            ...
            fs_1.default.writeFileSync(filePath, importHeader);
        }
        ...
        methodKeys.forEach((method) => {
            ...
            const apiContext = {
                ...
                method,
                url,
                inType: (inResult === null || inResult === void 0 ? void 0 : inResult.objName) && (0, tools_js_1.defPrefix)(inResult === null || inResult === void 0 ? void 0 : inResult.objName),
...
Object.defineProperty(exports, "createConfig", { enumerable: true, get: function () { return tools_1.createConfig; } });
Object.defineProperty(exports, "loadConfig", { enumerable: true, get: function () { return tools_1.loadConfig; } });
