 ...
 * @returns
 */
function writeToIndexFile(typeName, outDir) {
    return __awaiter(this, void 0, void 0, function* () {
        const defFilePath = path_1.default.join(outDir, 'index.ts');
        // 新建
        if (!(yield (0, __1.checkExists)(defFilePath))) {
            yield promises_1.default.writeFile(defFilePath, `export { default as ${typeName} } from './${typeName}';\n`);
            return defFilePath;
        }
        ...
        if (defFileContent.indexOf(typeName) === -1) {
            // 追加
            yield promises_1.default.appendFile(defFilePath, `export { default as ${typeName} } from './${typeName}';\n`);
        }
        return defFilePath;
    });
}
